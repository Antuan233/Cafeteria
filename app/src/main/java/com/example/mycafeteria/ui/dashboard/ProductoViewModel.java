...
public class ProductoViewModel extends ViewModel {
    ...
    private void inicializarProductos() {
        ...
        productos.add(new Producto("Latte", 28.0, "espresso con leche al vapor"));
        productos.add(new Producto("Frappe", 30.0, "cafe frio"));
        productos.add(new Producto("café Moka", 30.0, "expresso con chocolate"));
